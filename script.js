...
// To Display the content of clicked row 
 function row(index) {
    ...
    document.getElementById('id').innerHTML  = table[index].getElementsByTagName("td")[0].innerText
    document.getElementById('fname').innerHTML  = table[index].getElementsByTagName("td")[1].innerText
    document.getElementById('lname').innerHTML  = table[index].getElementsByTagName("td")[2].innerText
    document.getElementById('mail').innerHTML  = table[index].getElementsByTagName("td")[3].innerText
 }